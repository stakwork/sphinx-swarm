...
pub fn setup_logs() {
    simple_logger::SimpleLogger::new()
        ...
        .with_module_level("aws_sdk_s3", log::LevelFilter::Info)
        .with_module_level("aws_config", log::LevelFilter::Info)
        .with_module_level("aws_smithy_types", log::LevelFilter::Info)
        .with_module_level("aws_sigv4", log::LevelFilter::Info)
